               ...
               <!--- <div class="row">
                  ...
                  < <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            ...
                            <h3>Charter</h3>
                            <p>Disfruta de nuestros botes exclusivos y personalizados.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            <i class="fa fa-users fa-2x"></i>
                            <h3>Viaje Compartido</h3>
                            <p>Viaja con tus seres queridos y comparte tu experiencia con nuestros usuarios VIP</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4" >
                        <img src="/assets/comercial/img/freeze/iphone-freeze.png" class="img-responsive scrollpoint sp-effect5" alt="">
                    </div>
...
-->
    ...
    <div id="motor">
            <div id="motor_reserva" class="">  
        <ul class="nav nav-tabs">
            <li class="active"> 
                <a  href="#reserva" data-toggle="tab">Reservar</a>
            </li>
           
            <li>
                <a href="#detalle_reserva" data-toggle="tab">Ver reserva</a>
            </li>
        </ul>
        <div class="tab-content ">
              <div class="tab-pane active" id="reserva">
              <!-- <form role="form" action="{{ route('reservar')}}" method="post">
                   <div class="row">
                   {{ csrf_field() }}
                    <div class="col-lg-6 label_reserva">
                        <label for="sel1">Adultos</label>
                        <select class="form-control" id="sel1" name="cant_adultos">
                            <option>0</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                    ...
                    <div class="col-lg-6 label_reserva">
                        <label for="sel1">Niños</label>
                        <select class="form-control" id="sel1"  name="cant_niños">
                            <option>0</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                   ...
                   <div class="row">
                       <div class="col-lg-6 label_reserva">
                            <label for="sel1">fecha del viaje</label>
                            <div class="controls">
                                <input class="datepicker form-control"  name="fecha" type="text"/>
                            </div>
                        </div>
                        <div class="col-lg-6 btn_reserva">
                            <button type="button" onclick="window.location.href='/Users/christian%20duban/Documents/GitHub/botestheme/Oleose/Freeze/reserva.html'" class="btn btn-default"> Reservar</button>
                        </div>
                    </div>
                    </form>-->
